...
import static org.launchcode.qleanquotes.ApiClient.*;
...
//        model.addAttribute(new PaymentFormDTO());
    ...
    @RequestMapping("/")
    String index(Map<String, Object> model, ApiClient client) throws InterruptedException, ExecutionException {
    ...
    @ResponseBody
    PaymentResult processPayment(@RequestBody TokenWrapper tokenObject, SquareClient squareClient)
